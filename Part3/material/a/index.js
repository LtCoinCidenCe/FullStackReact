...
const Note = require('./models/note'); // to database

const app = express();
app.use(cors());
app.use(express.json()); // middleware to make incoming requests json
app.use(express.static('build')); // serve static files (frontend)

const requestLogger = (request, response, next) =>
{
  // middleware to show request
